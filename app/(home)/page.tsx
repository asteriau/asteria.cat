...
export default function Page() {
  return (
    <div className="h-full md:col-span-5 md:row-span-3 flex flex-col md:grid md:grid-cols-5 gap-4 items-left justify-center animate-page-in">
      ...
      <Card className="max-w-full max-h-full w-screen text-neutral-300 md:col-span-5 md:row-span-2">
        <div className="text-xl mb-1 font-semibold text-paradise-200 opacity-0 animate-[fadeIn_0.5s_ease-out_0.3s_forwards]">
          Who am I?
        </div>
      ...
      <Card className="p-0 text-lg w-screen max-w-full bg-[#1E1E1E]/50 flex flex-col justify-center items-center md:col-span-2 md:row-span-1">
        <div className="flex flex-col h-full justify-center items-center text-paradise-200 text-base">
          <noscript>
