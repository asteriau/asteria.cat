...
const COLORS = {
  light: [0x8caaee, 0x8caaee, 0xf4b8e4, 0xf4b8e4],
  dark: [0x4a044e, 0x3b0764, 0x1e1b4b, 0x020617],
};

const COLORS_HEX = {
  light: ["#8caaee", "#8caaee", "#f5c2e7", "#f5c2e7"],
...
const GradientReact = () => {
  ...
  return (
    <>
      <div
        ref={overlayRef}
        className={`fixed left-0 top-0 w-screen h-screen bg-pink-100 dark:bg-neutral-900 transition-opacity duration-1000 -z-10`}
      />
      <canvas
        id="gradient-canvas"
        ref={canvasRef}
