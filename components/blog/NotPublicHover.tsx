...
export const NotPublicHover = () => {
  ...
  return (
    ...
    >
      <div className={`absolute bottom-8 left-0 w-max text-base p-1 font-mono bg-red-900 rounded-lg shadow-lg transition-200 transition-all ${isHovered ? "opacity-100" : "opacity-0"}`}>
