...
import Ambilight from "@/components/home/Ambilight";
...
const FM_KEY = "96b9c57cebc5f68c170debc825af577e"; // oh nooooo oh nooooooooooooo (i dont gaf i can just gen another)
const MAIN = "asteriau";
        ...
        <div className="flex flex-row items-center justify-left w-screen h-full max-w-full">
          ...
          <div className="h-24">
            ...
            "https://lastfm.freetls.fastly.net/i/u/300x300/2a96cbd8b46e442fc41c2b86b821562f.png" ? (
              <div className="flex flex-col items-center justify-center text-center text-sm text-neutral-400 mr-4 w-24 h-24 self-center contain-content rounded-lg margin-auto ambilight bg-paradise-magenta/20 z-20 border border-[#424242]/30">
              ...
              <img
                src={data.imageUrl}
                alt="cover"
                className="mr-4 max-w-24 max-h-24 self-center contain-content rounded-lg margin-auto ambilight z-20 border border-[#424242]/30"
              />
            )}
          </div>
          <div className="flex flex-col items-left justify-center w-min leading-normal max-w-[calc(95%-6rem)]">
            <div className="text-sm text-neutral-400 text-left w-max">
              {data.isCurrent ? "Now Playing" : "Last Played"} on{" "}
              <Link href={`https://www.last.fm/user/${MAIN}`} target="_blank">
                <FaLastfm className="inline text-base mb-0.5 hover:text-paradise-300 transition-colors duration-150" />
              </Link>
            </div>
            <Link
            ...
            >
              <ScrollingText
                className="hover:text-paradise-300 transition-colors duration-150"
                text={`${data.name}`}
              />
            </Link>
            <Link
